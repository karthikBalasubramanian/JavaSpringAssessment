...
public class ProductResourceIntegrationTest {
    ...
    public void testConnections() {
        ...
        Assert.assertNotNull(wac.getBean("productResource"));
    }

    @Test
    public void listProducts() throws Exception {

        MvcResult mvcResult = (MvcResult) this.mockMvc.perform(get("/products")).andDo(print()).andExpect(status().isOk()).andReturn();
